...
const Layout = (props: Props) => {
  return (
    <div className="h-screen overflow-hidden bg-slate-700">
      <div className="h-full">
        ...
        <header className="h-12 bg-white shadow-sm">
          <div className="mx-auto flex h-12 max-w-7xl flex-row items-center justify-start gap-x-4 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <main className="h-full bg-white/40">
          <div className="relative mx-auto h-full w-full  py-6 sm:px-6 lg:px-8">
            {props.children}
          </div>
        </main>
      </div>
